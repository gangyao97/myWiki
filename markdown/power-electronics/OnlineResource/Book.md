## Power Electronics Book
 ...
 - [CU Boulder] Introduction to Power Electronics - Archived website of Introduction to Power Electronics from Colorado University, by Prof. Erickson
...
## Motor Drive Books
 - "Electric Motor Drives: Modeling, Analysis, and Control"
   - By R. Krishnan
   - A classic book in motor drives, covering DC/induction/PMSM/SRM control methods (scalar, vector, DTC).